...
def interpretaP(P):
    ...
    '''
    if P <= 15:
        return "Muy difícil, Publicación científica o filosófica, Titulados universitarios"
    elif P > 15 and P <= 35:
        return "Árido, publicación pedagógica o técnica, selectividad y estudios universitarios"
    elif P > 35 and P <= 50:
        return "bastante difícil, publicación de literatura y divulgación, estudios de cursos secundarios"
    elif P > 50 and P <= 65:
        return "normal, publicación para los medios, popular"
    elif P > 65 and P <= 75:
        return "bastante fácil, novela, 12 años"
    elif P > 75 and P <= 85:
        return "fácil, para quioscos, 11 años"
    else:
        return "muy fácil, cómics, tebeos y viñetas, 6 a 10 años"
...
def interpretaL(L):
    if L < 30:
        return "muy difícil (Universitario, especialización)"
    elif L >= 30 and L < 50:
        return "difícil (Cursos selectivos)"
    elif L >= 50 and L < 60:
        return "algo difícil (Preuniversitario)"
    elif L >= 60 and L < 70:
        return "normal (7 u 8 grado)"
    elif L >= 70 and L < 80:
        return "algo fácil (6to grado)"
    elif L >= 80 and L < 90:
        return "fácil (5to grado)"
    else:
        return "muy fácil (4to grado)"
